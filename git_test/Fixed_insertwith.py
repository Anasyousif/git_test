...
class RBTree:
    ...
    def fix_insert(self, new_node):
        ...
        while new_node != self.root and new_node.parent.red:
            ...
            if new_node.parent == new_node.parent.parent.right:
                ...
                # Case: Uncle is black
                    ...
                    # If current node is the left child (Triangle)
            ...
            # 3. If the parent is a left child of the grandparent (Mirror)
            else:
                ...
                # Case: Uncle is black
                    ...
                    # If current node is the right child (Triangle)
        ...
        # 4. Final step: Recolor the root to black
        self.root.red = False
